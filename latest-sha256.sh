...
# `pnpm view @pkitazos/git-jump dist.tarball` gets tarball URL of the latest package version
...
pnpm view @pkitazos/git-jump dist.tarball | xargs -n 1 curl --silent -o - | shasum -a 256 | awk '{print $1}'
